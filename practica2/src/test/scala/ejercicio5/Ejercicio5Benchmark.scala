...
object Ejercicio5Benchmark extends App{
    ...
    def criterioDouble (num1 : Double, num2: Double) = num1>num2
    // Tiempos con busqueda binaria
    //Arrays de enteros
    val tiemposBusquedaBinariaEnteros10 = configuracion measure(
        arrayEnterosTam10.foreach(valor =>
            ejercicio5.BusquedaBinariaGenerica.busquedaBinaria(arrayEnterosTam10, valor, criterioEnteros)
        ))

    val tiemposBusquedaBinariaEnteros50 = configuracion measure(
        arrayEnterosTam50.foreach(valor =>
            ejercicio5.BusquedaBinariaGenerica.busquedaBinaria(arrayEnterosTam50, valor, criterioEnteros)
        ))

    val tiemposBusquedaBinariaEnteros100 = configuracion measure(
        arrayEnterosTam100.foreach(valor =>
            ejercicio5.BusquedaBinariaGenerica.busquedaBinaria(arrayEnterosTam100, valor, criterioEnteros)
        ))

    val tiemposBusquedaBinariaEnteros500 = configuracion measure(
        arrayEnterosTam500.foreach(valor =>
            ejercicio5.BusquedaBinariaGenerica.busquedaBinaria(arrayEnterosTam500, valor, criterioEnteros)
        ))

    val tiemposBusquedaBinariaEnteros1000 = configuracion measure(
        arrayEnterosTam1000.foreach(valor =>
            ejercicio5.BusquedaBinariaGenerica.busquedaBinaria(arrayEnterosTam1000, valor, criterioEnteros)
        ))

    // Arrays de double
    val tiemposBusquedaBinariaDouble10 = configuracion measure(
        arrayDoubleTam10.foreach(valor =>
            ejercicio5.BusquedaBinariaGenerica.busquedaBinaria(arrayDoubleTam10, valor, criterioDouble)
        ))

    val tiemposBusquedaBinariaDouble50 = configuracion measure(
        arrayDoubleTam50.foreach(valor =>
            ejercicio5.BusquedaBinariaGenerica.busquedaBinaria(arrayDoubleTam50, valor, criterioDouble)
        ))

    val tiemposBusquedaBinariaDouble100 = configuracion measure(
        arrayDoubleTam100.foreach(valor =>
            ejercicio5.BusquedaBinariaGenerica.busquedaBinaria(arrayDoubleTam100, valor, criterioDouble)
        ))

    val tiemposBusquedaBinariaDouble500 = configuracion measure(
        arrayDoubleTam500.foreach(valor =>
            ejercicio5.BusquedaBinariaGenerica.busquedaBinaria(arrayDoubleTam500, valor, criterioDouble)
        ))

    val tiemposBusquedaBinariaDouble1000 = configuracion measure(
        arrayDoubleTam1000.foreach(valor =>
            ejercicio5.BusquedaBinariaGenerica.busquedaBinaria(arrayDoubleTam1000, valor, criterioDouble)
        ))
    ...
    val tiemposBusquedaSaltosEnteros10 = configuracion measure(
        arrayEnterosTam10.foreach(valor =>
            ejercicio5.BusquedaSaltosGenerica.busquedaSaltosGenerica(arrayEnterosTam10, valor, criterioEnteros)
        ))

    val tiemposBusquedaSaltosEnteros50 = configuracion measure(
        arrayEnterosTam50.foreach(valor =>
            ejercicio5.BusquedaSaltosGenerica.busquedaSaltosGenerica(arrayEnterosTam50, valor, criterioEnteros)
        ))

    val tiemposBusquedaSaltosEnteros100 = configuracion measure(
        arrayEnterosTam100.foreach(valor =>
            ejercicio5.BusquedaSaltosGenerica.busquedaSaltosGenerica(arrayEnterosTam100, valor, criterioEnteros)
        ))

    val tiemposBusquedaSaltosEnteros500 = configuracion measure(
        arrayEnterosTam500.foreach(valor =>
            ejercicio5.BusquedaSaltosGenerica.busquedaSaltosGenerica(arrayEnterosTam500, valor, criterioEnteros)
        ))

    val tiemposBusquedaSaltosEnteros1000 = configuracion measure(
        arrayEnterosTam1000.foreach(valor =>
            ejercicio5.BusquedaSaltosGenerica.busquedaSaltosGenerica(arrayEnterosTam1000, valor, criterioEnteros)
        ))

    // Arrays de double
    val tiemposBusquedaSaltosDouble10 = configuracion measure(
        arrayDoubleTam10.foreach(valor =>
            ejercicio5.BusquedaSaltosGenerica.busquedaSaltosGenerica(arrayDoubleTam10, valor, criterioDouble)
        ))

    val tiemposBusquedaSaltosDouble50 = configuracion measure(
        arrayDoubleTam50.foreach(valor =>
            ejercicio5.BusquedaSaltosGenerica.busquedaSaltosGenerica(arrayDoubleTam50, valor, criterioDouble)
        ))

    val tiemposBusquedaSaltosDouble100 = configuracion measure(
        arrayDoubleTam100.foreach(valor =>
            ejercicio5.BusquedaSaltosGenerica.busquedaSaltosGenerica(arrayDoubleTam100, valor, criterioDouble)
        ))

    val tiemposBusquedaSaltosDouble500 = configuracion measure(
        arrayDoubleTam500.foreach(valor =>
            ejercicio5.BusquedaSaltosGenerica.busquedaSaltosGenerica(arrayDoubleTam500, valor, criterioDouble)
        ))

    val tiemposBusquedaSaltosDouble1000 = configuracion measure(
        arrayDoubleTam1000.foreach(valor =>
            ejercicio5.BusquedaSaltosGenerica.busquedaSaltosGenerica(arrayDoubleTam1000, valor, criterioDouble)
        ))
